...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/string-wrap
   cd string-wrap
   ```
...
```sh
https://github.com/flex-development/string-wrap/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/string-wrap/discussions/new?category=q-a
